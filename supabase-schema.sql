...
INSERT INTO platforms (name, url, badge_color, crawler_type) VALUES
  ...
  ('미스터블로그', 'https://www.mrblog.net/', '#3b82f6', 'html_parser'),
  ('다이닝퀸', 'https://dinnerqueen.net/', '#ec4899', 'html_parser'),
  ...
  ('토잡', 'https://www.tojobcn.com/', '#ef4444', 'html_parser'),
  ('블로그체험단', 'https://xn--939au0g4vj8sq.net/', '#14b8a6', 'html_parser'),
  ('테이블', 'https://www.tble.kr/', '#f97316', 'html_parser'),
  ...
  ('포블로그', 'https://4blog.net/', '#ec4899', 'html_parser'),
  ...
  ('파블로뷰', 'https://pavlovu.com/index.php', '#f97316', 'html_parser'),
  ('리뷰팅', 'https://www.reviewting.net/index.php', '#8b5cf6', 'html_parser'),
  ('체험단모집', 'https://xn--vk1bn0kvydxrlprb.com/', '#3b82f6', 'html_parser'),
  ('리뷰진', 'https://reviewjin.com/', '#ec4899', 'html_parser'),
  ('프롬블로그', 'https://www.from-blog.com/', '#10b981', 'html_parser'),
  ('리뷰플레이스', 'https://www.reviewplace.co.kr/', '#f59e0b', 'html_parser'),
  ('리민', 'https://remin.co.kr/', '#6366f1', 'html_parser'),
