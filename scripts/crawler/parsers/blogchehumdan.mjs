// 블로그체험단 (xn--939au0g4vj8sq.net) — /cp/?id=
...
export async function parse(baseUrl) {
  ...
  for (let page = 1; page <= 3; page++) {
    ...
    } catch (err) { console.warn(`[블로그체험단] 페이지 ${page} 실패:`, err.message); break }
